...
* Learned: How to typeset documents in GitHub! (Also: Dan hates lack of spacing)
...
#### Completed Goals
* Completed my part on the requirements doc and added additional elements to ensure all bases were covered
* Got IntellIJ and GitHub set up and running

#### Progress and Issues
* Worked: smoothly completed everything we planned, all tools are prepped
* Didn't work: attending remote meetings (will be resolved)
* Learned: about how a single app can have so many use cases and alternative scenarios that should be considered
* Troubles: n/a (for now)
* Blockers: n/a (for now)

#### Plan for Next Week
* Attending all online and in person meetings
* Conversing with ChatGPT about my troubles (i.e. UI/UX)
* Completing our next milestone!
