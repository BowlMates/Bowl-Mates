...
* Bottomlined building out a couple of our pages: sign up, availability, and landing
* Finished UI figma to help plan our layout for our next steps

-- Progress and Issues --

-- Things I had trouble with--
* Reading a bunch of documentation for React and MUI, balancing that with having time to code
* Timing! I have an unfortunate work schedule that collides with when most of my team is getting stuff done (Fri/Sat)

-- Blocks --
* Nothing specific that wasn't able to get finished

-- Plans and Goals for Next Week --
* Counteracting my unfortunate work schedule by doing the bulk of my work on Wed/Thurs
* Set up CI to run gradle tests after building on each main commit
* Work on interactive user cards
* Doll up the favorite restaurants page (including getting a gMap on there)
* Continue herding the cats when they go astray
...
-- Goals (accomplished) for this past week --
* set up a UI and UI skeletons for the settings, matching, and faq

-- Progress and Issues --
* we got some parts of our UI to be functional with the backend 
* no issues other than having to read and learn more about our UI components

-- Things I had trouble with--
* started a bit late on making the UI (will improve this)

-- Blocks --
* N/A for now

-- Plans and Goals for Next Week --
* create user cards and functional "swipe"
* reformat restaurant page and design restaurant cards
* implement MUI alerts where necessary
* edit the settings page for existing users to edit personal info
* adding tasks, bugs, and issues to github issues
