    ...
    return (
        <Container maxWidth="sm">
            ...
            <Grid container spacing={2}>
                <Grid item xs={6}>
                    <TextField id="filled-basic" label="display name" variant="filled" fullWidth={true} inputProps={{ maxLength: 30 }}/>
                </Grid>
                <Grid item xs={6}>
                    <TextField id="filled-basic" label="pronouns" variant="filled" fullWidth={true} inputProps={{ maxLength: 30 }}/>
                </Grid>
                <Grid item xs={12}>
                    <TextField
